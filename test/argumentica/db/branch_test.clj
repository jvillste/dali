...
(defn transaction [branch]
  (map common/datom-to-eacv-statemnt
       (common/squash-statements (common/datoms (:branch-sorted-set-db branch)))))

(defn values [branch entity-id attribute]
  (common/values-from-eatcv-datoms (datoms branch entity-id attribute)))
